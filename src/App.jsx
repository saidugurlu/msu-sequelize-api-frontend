...
function App() {
  ...
  const handleDeleteButton = (e, flashcard) => {
    axios
      ...
      .then(function (response) {
        console.log(response);
        const _flashcards = flashcards.filter((m) => m.id !== flashcard.id);
        setFlashcards(_flashcards);
      })
      .catch(function (error) {
        console.log(error);
              ...
              {!flashcard.editing ? (
                <>
                  ...
                  <div className="buttonArea">
                    <button
                      className="delete"
                      onClick={(e) => handleDeleteButton(e, flashcard)}
                    >
                      Delete
                    </button>
                    <button
                      className="edit"
                      onClick={(e) => handleEditButton(e, flashcard)}
                    >
                      Edit
                    </button>
                  </div>
                ...
                <>
                  <div className="category">
                    ...
                    <input
                      ...
                      onChange={(e) => handleChangeCategory(e, flashcard)}
                    />
                  </div>
                  <div className="front">
                    Front:{" "}
                    <input
                      ...
                      onChange={(e) => handleChangeFront(e, flashcard)}
                    />
                  </div>
                  <div className="back">
                    Back:{" "}
                    <input
                      ...
                      onChange={(e) => handleChangeBack(e, flashcard)}
                    />
                  </div>
                  <div className="buttonArea">
                    <button
                      className="saveEditFlashcard"
                      onClick={(e) => handleSaveButton(e, flashcard)}
                    >
                      Save
                    </button>
                    <button
                      className="cancel"
                      onClick={(e) => handleCancelButton(e, flashcard)}
                    >
                      Cancel
                    </button>
                  </div>
